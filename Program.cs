...
partial class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        var cupTournamentFileName = $"FifaCupTournament_{Path.GetFileNameWithoutExtension(teamFile)}.json";
        var cupTournamentFilePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData),cupTournamentFileName);
